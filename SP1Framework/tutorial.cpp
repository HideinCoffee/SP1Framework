...
void createtutobj(Map &map) {
	...
	enemyarray[2] = new Mobs(119, 37, 2, 2, 20, false, false, mobmovement);
	enemyarray[3] = new Mobs(119, 40, 3, 2, 20, false, false, mobmovement);
	enemyarray[4] = new Mobs(119, 43, 4, 2, 20, false, false, mobmovement);
	enemyarray[5] = new Mobs(119, 46, 5, 2, 20, false, false, mobmovement);
	enemyarray[6] = new Mobs(119, 49, 6, 2, 20, false, false, mobmovement);
	enemyarray[7] = new Mobs(119, 52, 7, 2, 20, false, false, mobmovement);
	enemyarray[8] = new Mobs(119, 55, 8, 2, 20, false, false, mobmovement);
	enemyarray[9] = new Mobs(119, 58, 9, 2, 20, false, false, mobmovement);
	enemyarray[10] = new Mobs(119, 61,10, 2, 20, false, false, mobmovement);
	enemyarray[11] = new Mobs(119, 64, 11, 2, 20, false, false, mobmovement);
	enemyarray[12] = new Mobs(119, 67, 12, 2, 20, false, false, mobmovement);
	enemyarray[13] = new Mobs(119, 70, 13, 2, 20, false, false, mobmovement);
	enemyarray[14] = new Mobs(119, 73, 14, 2, 20, false, false, mobmovement);
	enemyarray[15] = new Mobs(119, 76, 15, 2, 20, false, false, mobmovement);
	enemyarray[16] = new Mobs(119, 79, 16, 2, 20, false, false, mobmovement);
	enemyarray[17] = new Mobs(119, 82, 17, 2, 20, false, false, mobmovement);
	enemyarray[18] = new Mobs(119, 85, 18, 2, 20, false, false, mobmovement);
	enemyarray[19] = new Mobs(119, 88, 19, 2, 20, false, false, mobmovement);
	enemyarray[20] = new Mobs(119, 91, 20, 2, 20, false, false, mobmovement);
	enemyarray[21] = new Mobs(119, 94, 21, 2, 20, false, false, mobmovement);
	enemyarray[22] = new Mobs(119, 97, 22, 2, 20, false, false, mobmovement);
